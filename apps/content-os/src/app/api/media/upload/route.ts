...
// hazard: Path generation uses Math.random() which is not cryptographically secure; predictable paths could allow enumeration of uploaded files
...
// hazard: FormData parsing doesn't validate field names; extra fields silently ignored, could mask malformed requests
