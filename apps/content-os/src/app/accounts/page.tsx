...
const PLATFORMS: PlatformMeta[] = [
  ...
  { id: 'instagram', label: 'Instagram',     icon: '\u25FB',       color: '#E1306C', description: 'Photos, Stories & Reels',            oauthUrl: '/api/oauth/instagram/authorize' },
  { id: 'youtube',   label: 'YouTube',       icon: '\u25B6',       color: '#FF0000', description: 'Video content & Shorts',             oauthUrl: '/api/oauth/youtube/authorize' },
  { id: 'tiktok',    label: 'TikTok',        icon: '\u266A',       color: '#000000', description: 'Short-form video',                   oauthUrl: '/api/oauth/tiktok/authorize' },
