// @crumb content-os-error-boundary
// [UI] | React class error boundary | Global error catch component
// why: Catches unhandled React render errors to prevent full-page crashes and give users recovery path
...
// edge:apps/content-os/src/app/layout.tsx -> USED_BY
